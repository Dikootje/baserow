...
# The hour of the day when the daily and weekly email notifications task is
# scheduled, according to the user timezone. Every hour a task is scheduled
# and only the users in the correct timezone will receive an email.
...
# according to the user timezone.
...
# seconds.
EMAIL_NOTIFICATIONS_AUTO_RETRY_IF_LIMIT_REACHED_AFTER_SECONDS = (
