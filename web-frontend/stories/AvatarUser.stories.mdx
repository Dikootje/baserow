...
export const Template = (args, { argTypes }) => ({
    ...
    template: `<Avatar v-bind="$props">${args.default}</Avatar>`,
})
...
<Canvas>
    ...
    <Story
        name="Magenta"
        args={{ color: 'magenta', initials: 'RF' }}
        parameters={{
            design: config(designConfig),
        }}
    >
    ...
    <Story
        name="Neutral"
        args={{ color: 'neutral', initials: 'RF' }}
        parameters={{
            design: config(designConfig),
        }}
    >
