...
describe('Checkbox', () => {
  ...
  it('renders an indeterminate state when indeterminate and checkes props are true', async () => {
    const wrapper = mount(Checkbox, {
      propsData: {
        indeterminate: true,
        checked: true,
  ...
  it('renders a variant style when styleVariant prop is true', () => {
    const wrapper = mount(Checkbox, {
      propsData: {
        styleVariant: true,
      },
    ...
    expect(wrapper.find('.checkbox--variant').exists()).toBe(true)
  })
})
